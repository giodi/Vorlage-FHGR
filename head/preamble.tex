\usepackage{titlesec, fontspec, setspace, fancyhdr, lscape, caption, subcaption, floatrow, inputenc, graphicx, enumitem, tabularx, colorprofiles, tocloft, xstring, hyphenat, chngcntr}
...
\captionsetup[table]{font={footnotesize},labelfont=it,labelsep=period}
\captionsetup[figure]{font={footnotesize},labelfont=it,labelsep=period}
% \captionsetup[subfigure]{font={footnotesize},labelfont=it,labelsep=period,labelformat=simple}
...
\renewcommand{\arraystretch}{1.3} % Zeilenabstand innerhalb von Tabellen
\setlength{\parindent}{2.23em} % Einzug neuer Absatz
\fancyhf{}
...
% \newcommand\FakeChapter[1]{{\huge\textbf{{#1}}}}
\newcommand{\FakeChapter}[2]{%
    ...
    \noindent
    {\normalfont\large\bfseries{#1}}\vspace{6pt}\\%
}%
